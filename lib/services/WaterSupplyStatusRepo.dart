...
class WaterSupplyStatusRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> waterSupplyStatus(BuildContext context) async {
    ...
    try {
      ...
      var endPoint = "WaterSupplyStatus/WaterSupplyStatus";
