...
class PendingForOccupancyCertificateRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> pendingForCertificate(BuildContext context) async {
    ...
    try {
      ...
      var endPoint = "PendingForOccupancyCertificate/PendingForOccupancyCertificate";
