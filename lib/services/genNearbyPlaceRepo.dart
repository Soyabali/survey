...
class GetNearbyPlaceRepo {
  GeneralFunction generalFunction = GeneralFunction();
  Future<List<Map<String, dynamic>>?> getNearByPlace(BuildContext context) async {
    ...
    try {
      ...
      var getNearByPlaceApi = "$baseURL$endPoint";
      showLoader();
      ...
      var request = http.Request('GET', Uri.parse('$getNearByPlaceApi'));
