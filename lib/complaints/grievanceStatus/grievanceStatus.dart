              ...
              children: [
                Container(
                  ...
                  height: 50,
                    ...
                    leading:  Container(
                      width: 35,
                      height: 35, // Height and width must be equal to make it circular
                    ...
                    title: Text("Ward No -5",style: TextStyle(
                ...
                Positioned(
                  ...
                  child: Container(
                    width: 50,
                    height: 50, // Height and width must be equal to make it circular
                    decoration: const BoxDecoration(
                      color: Colors.red,
                      shape: BoxShape.circle, // Makes the container circular
                      boxShadow: [
