...
class _MyHomePageState extends State<PropertyAssessment> {
  ...
  bool isFormVisible = false; // Track the visibility of the form
...
// Conditional visibility for the form
                  Expanded(
                    child: AnimatedContainer(
                      duration: Duration(milliseconds: 300),
                      height: isFormVisible ? MediaQuery.of(context).size.height : 0, // Show or hide based on form visibility
                      child: Visibility(
