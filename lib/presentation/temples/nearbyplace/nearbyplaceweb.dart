...
class NearByPlaceWebView extends StatefulWidget {
  const NearByPlaceWebView({super.key});

  @override
  State<NearByPlaceWebView> createState() => _WebViewStackState();
}

class _WebViewStackState extends State<NearByPlaceWebView> {
