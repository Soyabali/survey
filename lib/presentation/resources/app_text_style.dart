...
class AppTextStyle {
  ...
  // puri application textStyle
  static TextStyle font30penSansExtraboldWhiteTextStyle = GoogleFonts.openSans(
  ...
  static TextStyle font14penSansExtraboldWhiteTextStyle = GoogleFonts.openSans(
    color: AppColors.white,
    fontSize: 14,
    fontWeight: FontWeight.w600,
    fontStyle: FontStyle.normal,
  ...
  static TextStyle font20penSansExtraboldWhiteTextStyle = GoogleFonts.openSans(
    color: AppColors.white,
    fontSize: 20,
    fontWeight: FontWeight.w600,
    fontStyle: FontStyle.normal,
  ...
  // black 26
  static TextStyle font14OpenSansRegularBlack26TextStyle = GoogleFonts.openSans(
  ...
  static TextStyle font10penSansExtraboldBlack45TextStyle = GoogleFonts.openSans(
    //color: Color(0xFFC0C0C0),// silver
    color:Colors.black45,
    fontSize: 10,
    fontWeight: FontWeight.w600,
  ...
  static TextStyle font12penSansExtraboldBlack45TextStyle = GoogleFonts.openSans(
    //color: Color(0xFFC0C0C0),// silver
    color:Colors.black45,
    fontSize: 12,
    fontWeight: FontWeight.w600,
  ...
  static TextStyle font24OpenSansExtraboldWhiteTextStyle = GoogleFonts.openSans(
      color: AppColors.white, fontSize: 24, fontWeight: FontWeight.w800);
       static TextStyle font24OpenSansExtraWhiteTextStyle = GoogleFonts.openSans(
  ...
  static TextStyle font18OpenSansExtraboldPurpleTextStyle =
      GoogleFonts.openSans(
  ...
  static TextStyle font18OpenSansExtraBoldLightGreenTextStyle =
      GoogleFonts.openSans(
          color: AppColors.lightGreen,
          fontSize: 18,
          fontWeight: FontWeight.w800);
  ...
  static TextStyle font14OpenSansBoldWhiteTextStyle = GoogleFonts.openSans(
  ...
  static TextStyle font14OpenSansBoldLightGreenTextStyle = GoogleFonts.openSans(
      color: AppColors.lightGreen, fontSize: 14, fontWeight: FontWeight.w700);
